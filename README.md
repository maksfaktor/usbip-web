...
## Последние обновления (24.04.2025)

- Оптимизирована верстка страницы входа для идеального центрирования на всех размерах экрана
- Улучшен алгоритм определения языковой раскладки клавиатуры
- Добавлена визуальная индикация Caps Lock на странице входа
- Улучшена отзывчивость интерфейса на мобильных устройствах
- Исправлены проблемы с отображением в различных браузерах
...
- Управлять виртуальным хранилищем для эмулируемых USB-накопителей
