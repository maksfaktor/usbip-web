...
// ================================================================================
//
// File: identities/saved_state.go
// Project: Orange USB/IP Web Interface - Virtual FIDO Component
// Purpose: Serialize and encrypt the identity vault for persistent storage
//
// Vault File Format (vault.json):
//
//      The vault stores all FIDO2 credentials in an encrypted JSON format.
//      Double encryption protects the data:
//
//      1. Passphrase → scrypt → Master Key
//      2. Master Key encrypts Data Encryption Key (DEK)
//      3. DEK encrypts credential data
//
// Encryption Details:
//   - Key Derivation: scrypt (N=32768, r=8, p=1)
//   - Encryption: AES-256-GCM
//   - Salt: Random 32 bytes per vault
//   - Nonces: Random 12 bytes per encryption
//
// Saved Structures:
//
//      PassphraseEncryptedBlob
//      ├── Salt: scrypt salt
//      ├── EncryptionKey: Encrypted DEK
//      ├── KeyNonce: Nonce for DEK encryption
//      ├── EncryptedData: Encrypted vault data
//      └── DataNonce: Nonce for data encryption
//
//      FIDODeviceConfig
//      ├── EncryptionKey: Device encryption key
//      ├── AttestationCertificate: X.509 attestation cert
//      ├── AttestationPrivateKey: Attestation signing key
//      ├── AuthenticationCounter: Global auth counter
//      ├── PINEnabled: Whether PIN is set
//      ├── PINHash: Hashed PIN value
//      └── Sources: List of credential sources
//
// ================================================================================
package identities
