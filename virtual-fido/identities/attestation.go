...
// ================================================================================
//
// File: identities/attestation.go
// Project: Orange USB/IP Web Interface - Virtual FIDO Component
// Purpose: Generate and manage attestation certificates for the virtual FIDO device
//
// Attestation in FIDO2:
//
//      When registering a new credential, the authenticator signs the response
//      with an attestation key. This proves the authenticator's authenticity.
//      The attestation certificate is included in the registration response.
//
// Certificate Chain:
//
//      Root CA (self-signed)
//      └── Attestation Certificate (signed by Root CA)
//
// Certificate Details:
//   - Key Type: ECDSA P-256
//   - Validity: 20 years from creation
//   - Subject: Virtual FIDO Authenticator
//   - Key Usage: Digital Signature
//
// Functions:
//   - GenerateSelfSignedCertificate(): Create CA certificate
//   - SignCertificate(): Sign attestation cert with CA
//
// Security Note:
//
//      This is a self-attestation implementation. For production authenticators,
//      the attestation certificate chain would be signed by the manufacturer.
//
// ================================================================================
package identities
