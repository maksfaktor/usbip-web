...
// Purpose: USB protocol constants and descriptor structures
//
// USB Request Types:
//   - GET_STATUS (0): Get device/interface/endpoint status
//   - CLEAR_FEATURE (1): Clear feature (e.g., halt endpoint)
//   - SET_FEATURE (3): Set feature
//   - SET_ADDRESS (5): Assign device address
//   - GET_DESCRIPTOR (6): Get device/config/string descriptor
//   - SET_DESCRIPTOR (7): Set descriptor (rarely used)
//   - GET_CONFIGURATION (8): Get current configuration
//   - SET_CONFIGURATION (9): Set device configuration
//   - GET_INTERFACE (10): Get alternate interface setting
//   - SET_INTERFACE (11): Set alternate interface setting
//   - SYNCH_FRAME (12): Synchronize frame number
//
// Descriptor Types:
...
//   - HID_REPORT (0x22): HID report descriptor
//
// HID Class Requests:
//   - GET_REPORT (0x01): Get HID report
//   - SET_IDLE (0x0A): Set idle rate
//   - SET_PROTOCOL (0x0B): Set boot/report protocol
//
// ================================================================================
package usb
