...
// ================================================================================
//
// File: usb/usb_device.go
// Project: Orange USB/IP Web Interface - Virtual FIDO Component
// Purpose: Emulates a USB HID FIDO security key device
//
// USB Device Properties:
//
//      This file defines how the virtual FIDO device appears to the USB host:
//      - Bus ID: 2-2 (hardcoded for USB/IP attachment)
//      - Vendor ID: 0x0000 (Virtual)
//      - Product ID: 0x0000 (Virtual)
...
//      - Interface Protocol: 0x00 (No protocol)
//
// USB Descriptors:
//   - Device Descriptor: Basic device information
//   - Configuration Descriptor: Power and interface configuration
//   - Interface Descriptor: HID FIDO interface
//   - Endpoint Descriptors: IN/OUT interrupt endpoints
//   - HID Descriptor: FIDO HID report descriptor
//
// Data Flow:
//
//      USB Host (OS) → USB/IP → USBDevice → CTAP HID → CTAP/U2F
//
// HID Reports:
//   - 64-byte reports for CTAP HID protocol
//   - Endpoint 1 IN: Device to host
//   - Endpoint 1 OUT: Host to device
//
// ================================================================================
package usb
