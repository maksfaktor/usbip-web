// ================================================================================
// U2F (Universal 2nd Factor) Protocol Implementation
// ================================================================================
//
// File: u2f/u2f.go
// Project: Orange USB/IP Web Interface - Virtual FIDO Component
// Purpose: Implements legacy U2F protocol for backward compatibility
//
// U2F Protocol:
//
//      U2F is the predecessor to FIDO2/WebAuthn. While most modern sites use
//      WebAuthn (CTAP2), some older services still require U2F support.
//      This implementation provides that backward compatibility.
//
// Supported Commands:
//   - U2F_REGISTER (0x01): Register new key with service
//   - U2F_AUTHENTICATE (0x02): Authenticate with existing key
//   - U2F_VERSION (0x03): Return protocol version ("U2F_V2")
//
// Status Words:
//   - 0x9000: Success (no error)
//   - 0x6985: Conditions not satisfied (user presence required)
//   - 0x6A80: Wrong data
//   - 0x6700: Wrong length
//
// Authentication Modes:
//   - Check Only (0x07): Verify key handle exists
//   - Enforce User Presence (0x03): Require user touch
//   - Sign (0x08): Sign without user presence requirement
//
// Integration:
//
//      U2F commands are transported over CTAP HID layer, same as CTAP2.
//      The U2FServer handles U2F-specific message formats and responses.
//
// ================================================================================
package u2f
