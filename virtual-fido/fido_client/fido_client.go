// ================================================================================
// FIDO Client - Application Logic Layer
// ================================================================================
//
// File: fido_client/fido_client.go
// Project: Orange USB/IP Web Interface - Virtual FIDO Component
// Purpose: Implements the high-level FIDO client logic and credential management
//
// Client Responsibilities:
//
//      The FIDO client is the "brain" of the virtual security key. It handles:
//      - Credential creation and storage
//      - User verification (PIN, user presence)
//      - Attestation certificate management
//      - Data persistence (saving/loading vault)
//
// Client Actions:
//   - U2F Register: Create credential via legacy U2F
//   - U2F Authenticate: Sign via legacy U2F
//   - FIDO MakeCredential: Create credential via CTAP2
//   - FIDO GetAssertion: Authenticate via CTAP2
//
// Interfaces:
//
//      ClientRequestApprover
//      ├── ApproveClientAction(): Authorize credential operations
//
//      ClientDataSaver
//      ├── SaveData(): Persist encrypted vault
//      ├── RetrieveData(): Load encrypted vault
//      └── Passphrase(): Get encryption passphrase
//
// DefaultFIDOClient:
//
//      The main implementation that stores:
...
// Passphrase:
//
//      Vault encryption uses FIDO_PASSPHRASE environment variable.
//      If not set, a default passphrase is used (less secure).
//
// ================================================================================
package fido_client
