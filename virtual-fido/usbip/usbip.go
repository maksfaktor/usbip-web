...
// Purpose: USB/IP protocol constants, types, and data structures
//
// USB/IP Protocol:
//
//      USB/IP is a kernel-level protocol for sharing USB devices over TCP/IP.
//      This file defines the wire format for USB/IP messages.
//
// Protocol Version: 0x0111 (1.1.1)
//
// Control Commands (connection setup):
//   - OP_REQ_DEVLIST (0x8005): Client requests device list
//   - OP_REP_DEVLIST (0x0005): Server replies with device list
//   - OP_REQ_IMPORT (0x8003): Client requests to attach device
//   - OP_REP_IMPORT (0x0003): Server confirms attachment
//
...
//
// Direction:
//   - OUT (0x0): Host to device
//   - IN (0x1): Device to host
//
// Structures:
//   - USBIPDeviceSummary: Device descriptor for device list
//   - USBIPInterfaceSummary: Interface descriptor
//   - URB headers and data structures
//
// ================================================================================
package usbip
