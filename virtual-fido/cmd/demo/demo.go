// ================================================================================
// Virtual FIDO - Main CLI Application
// ================================================================================
//
// File: cmd/demo/demo.go
// Project: Orange USB/IP Web Interface - Virtual FIDO Component
// Purpose: Command-line interface for running the virtual FIDO2 security key
//
// This is the main entry point for the virtual-fido binary.
//
// Commands:
//
//      virtual-fido start
//      ├── Starts the USB/IP server on port 3241
//      ├── Loads vault from file (default: vault.json)
//      ├── Waits for USB/IP attachment
//      └── Serves FIDO2/U2F requests
//
//      virtual-fido list
//      ├── Lists all stored credentials
//      └── Shows: ID prefix, username, website
//
//      virtual-fido delete --id <prefix>
//      ├── Deletes credential by ID prefix
//      └── Requires unique prefix match
//
// Flags:
//   -f, --file: Vault file path (default: vault.json)
//   -p, --passphrase: Encryption passphrase (env: FIDO_PASSPHRASE)
//   -i, --id: Credential ID prefix for delete command
//   -v, --verbose: Enable debug logging
//
// Integration with Web Interface:
//
//      The Python Flask application (fido_utils.py) controls this binary via
//      subprocess, passing vault path and passphrase as arguments.
//
// ================================================================================
package main
