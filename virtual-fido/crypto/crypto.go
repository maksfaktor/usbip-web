...
// Purpose: Cryptographic primitives for FIDO2 operations
//
// Key Generation:
//   - ECDSA P-256: Primary algorithm for FIDO2 credentials
//   - Ed25519: Alternative signature algorithm
//   - RSA 4096-bit: For attestation and legacy support
//   - Symmetric (AES-256): For vault encryption
//
// Encryption:
...
//
// Signing:
//   - ECDSA-SHA256: Standard WebAuthn signatures
...
//   - SHA256Hash(): Hash computation
//   - EncodeECDSASignature(): DER encoding for ECDSA signatures
//
// Security Notes:
//   - All random data from crypto/rand (CSPRNG)
//   - No weak algorithms or deprecated ciphers
