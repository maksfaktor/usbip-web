// ================================================================================
// CTAP (Client to Authenticator Protocol) Implementation
// ================================================================================
//
// File: ctap/ctap.go
// Project: Orange USB/IP Web Interface - Virtual FIDO Component
// Purpose: Implements CTAP2 protocol for WebAuthn/FIDO2 authentication
//
// CTAP2 Protocol:
//
//      CTAP2 is the protocol used by WebAuthn authenticators (security keys) to
//      communicate with clients (browsers). This implementation supports the
//      core commands required for passwordless authentication.
//
// Supported Commands:
//   - authenticatorMakeCredential (0x01): Create new credential for registration
//   - authenticatorGetAssertion (0x02): Sign challenge for authentication
//   - authenticatorGetInfo (0x04): Return authenticator capabilities
//   - authenticatorClientPIN (0x06): PIN management operations
//   - authenticatorReset (0x07): Factory reset (disabled for safety)
//   - authenticatorGetNextAssertion (0x08): Get additional assertions
//
// Credential Storage:
//
//      Credentials are stored in an encrypted vault (vault.json) managed by the
//      identities package. Each credential contains:
//      - Relying Party ID (website domain)
//      - User handle
...
//   - Attestation using device certificate
//   - User verification via PIN or user presence
//   - Replay protection via sign counter
//
// AAGUID:
//
//      The Authenticator Attestation GUID identifies this authenticator type.
//      Value: 756c5af5-eca6-01a3-2fc6-d30ce2f201c5
//
// ================================================================================
package ctap
