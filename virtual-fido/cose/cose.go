...
// Purpose: COSE key and algorithm support for WebAuthn credentials
//
// COSE in WebAuthn:
//
//      WebAuthn uses COSE for representing public keys and cryptographic
//      algorithms in a compact binary format (CBOR encoding).
//
// Supported Algorithms:
//   - ES256 (-7): ECDSA with P-256 and SHA-256 (default for FIDO2)
//   - ES512 (-36): ECDSA with P-521 and SHA-512
//   - ED25519 (-8): Edwards-curve Digital Signature Algorithm
//   - PS256 (-37): RSASSA-PSS with SHA-256
//   - ECDH-HKDF-256 (-25): Key agreement for PIN protocol
//
// Supported Curves:
//   - P-256 (1): NIST P-256 curve (secp256r1)
//   - ED25519 (6): Edwards curve for EdDSA
//
// Key Types:
//   - EC2 (2): Elliptic Curve keys (ECDSA)
