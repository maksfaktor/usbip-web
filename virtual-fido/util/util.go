...
// Purpose: Common utility functions used throughout the virtual-fido codebase
//
// Error Handling:
//   - Panic(): Panic with stack trace
//   - Assert(): Panic if condition is false
//   - CheckErr(): Panic if error is not nil
//   - Try/Catch pattern for panic recovery
//
// Binary I/O:
//   - Read(): Read binary data from network connection
//   - Write(): Write binary data to network connection
//   - ReadLE/WriteLE: Little-endian variants
//   - Timeout handling for network operations
//
// Data Conversion:
//   - ToLE16/ToLE32/ToLE64: Integer to little-endian bytes
//   - FromLE16/FromLE32/FromLE64: Little-endian bytes to integer
//   - UTF16BytesToString: Convert UTF-16 to Go string
//
// CBOR Utilities:
//   - CBOREncode/CBORDecode: CBOR serialization helpers
//
// Slice Operations:
//   - Flatten: Combine multiple byte slices
//   - Pad: Pad slice to specified length
//   - SetLength: Resize slice to exact length
//
// ================================================================================
package util
