...
translations = {
    'en': {
        ...
        'terminal': 'Terminal',
        'clear': 'Clear',
        'terminal_welcome': 'Orange USB/IP Web Terminal',
        'terminal_help': 'Type commands below and press Enter to execute',
        'enter_command': 'Enter command...',
        'command_buttons': 'Command Buttons',
        'add': 'Add',
        'no_commands': 'No command buttons created yet',
        'error': 'Error',
        'server_error': 'Server Error',
        'technical_details': 'Technical Details',
        'create_command': 'Create Command Button',
        'command': 'Command',
        'command_help': 'Enter the shell command to execute',
        'description': 'Description',
        'create': 'Create',
        'edit_command': 'Edit Command Button',
        'confirm_delete': 'Confirm Delete',
        'delete_command_confirm': 'Are you sure you want to delete this command button?',
    ...
    'ru': {
        ...
        'run_doctor': 'Запустить диагностику',
        'running_doctor': 'Запуск диагностики...',
        'doctor_results': 'Результаты диагностики',
        ...
        'terminal': 'Терминал',
        'clear': 'Очистить',
        'terminal_welcome': 'Веб-терминал Orange USB/IP',
        'terminal_help': 'Введите команды ниже и нажмите Enter для выполнения',
        'error': 'Ошибка',
        'server_error': 'Ошибка сервера',
        'technical_details': 'Технические детали',
        'enter_command': 'Введите команду...',
        'command_buttons': 'Кнопки команд',
        'add': 'Добавить',
        'no_commands': 'Кнопки команд пока не созданы',
        'create_command': 'Создать кнопку команды',
        'command': 'Команда',
        'command_help': 'Введите команду shell для выполнения',
        'description': 'Описание',
        'create': 'Создать',
        'edit_command': 'Редактировать кнопку команды',
        'confirm_delete': 'Подтвердить удаление',
        'delete_command_confirm': 'Вы уверены, что хотите удалить эту кнопку команды?',
